                            ...
                            <div className="section-container">
                                <section className="left-section">
                                    ...
                                    <div className="form-group">
                                        ...
                                        />
                                        {shouldMarkError('firstName') && <small id="firstNameHelp" className="form-text alert alert-danger">{(!this.state.firstName ? 'Họ không được để trống!' : 'Họ phải viết in hoa và không được có khoảng trống!')}</small>}
                                    </div>
                                ...
                                <section className="right-section">
                                    ...
                                    <div className="form-group">
                                        ...
                                        />
                                        {shouldMarkError('lastName') && <small id="lastNameHelp" className="form-text alert alert-danger">{(!this.state.lastName ? 'Tên không được để trống!' : 'Tên phải bắt đầu bằng chữ cái in hoa và không được có khoảng trống!')}</small>}
                                    </div>
