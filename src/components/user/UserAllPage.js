                ...
                <article className="main-article-shared-content">
                    <section className="profile-content-section">
                        <div className="container col-md-10 text-center mb-4">
                            <h2 className="text-center font-weight-bold mt-4" style={{ 'margin': '1rem auto' }}>Danh sách người dùng</h2>
                            <table className="table table-hover mt-3 w-80 mx-auto text-center">
                                <thead>
                                    <tr className="row">
                                        ...
                                        <th className="col-md-2" scope="col">Quyền</th>
                                        <th className="col-md-7" scope="col">Hành động</th>
                                    </tr>
                                </thead>
                                <tbody>
