...
class UserFindFriendsPage extends Component {
    ...
    render() {
        ...
        if (requestLength > 0) {
            requests = (
                <Fragment>
                    <h4 className="mt-5">Trả lời yêu cầu kết bạn</h4>
        ...
        if (waitingForResponseUsers > 0) {
            friendsCandidates = (
                <Fragment>
                    <h4 className="mt-5">Lời mời đã gửi</h4>
                    <div className="hr-styles"></div>
                    {
        ...
        if (friendsCandidatesArr > 0) {
            remainCandidates = (
                <Fragment>
                    <h4 className="mt-5">Có thể bạn biết</h4>
                    <div className="hr-styles"></div>
                    {
                ...
                <article className="main-article-shared-content">
                    <section className="friend-content-section">
                        <div className="container col-md-12 text-center mb-5">
                            <h2 className="text-center font-weight-bold mt-4" style={{ 'margin': '1rem auto' }}>
                                Bạn bè
                            </h2>
                            <div className="hr-styles"></div>
