...
class UserGalleryPage extends Component {
    ...
    uploadFile = () => {
        ...
        if (!this.state.file) {
            toast.error(<ToastComponent.errorToast text='Hãy chọn đúng file ảnh!' />, {
                position: toast.POSITION.TOP_RIGHT
            });
            return;
        }
        ...
        if (this.state.file.size >= 2000000) {
            toast.error(<ToastComponent.errorToast text='Kích cỡ ảnh dưới 2MB!' />, {
                position: toast.POSITION.TOP_RIGHT
            });
            return;
        }
                ...
                <article className="aside-article-photos">
                    <div className="gallery-article-intro">
                        ...
                        <div className="gallery-aside-article-header"  >
                            ...
                            <h3 className="aside-article-title">Hình ảnh</h3>
                        </div>

                        {(isRoot || isTheCurrentLoggedInUser) && <div className="">
                            <button className="button update-info">
                                <label className="cursor-pointer" id="upload" htmlFor="fileUpload" > Thêm ảnh
                    ...
                    {this.props.picturesArr.length > 0
                        ...
                        <Fragment>
                            {!this.state.ready ?
                                ...
                                <Fragment>
                                    <div className="hr-styles" style={{ 'width': '90%' }}></div>
                                    <h4 className="text-center">Kho ảnh trống!</h4>
                                    <div className="hr-styles" style={{ 'width': '90%' }}></div>
                                </Fragment>
                            }
                        </Fragment>
