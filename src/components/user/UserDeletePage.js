                ...
                <article className="main-article-shared-content">
                    <section className="delete-content-section">
                        <div className="container mx-auto text-center mb-4" >
                            <h1 className="text-center font-weight-bold alert alert-danger position col-md-10 mt-4" style={{ 'margin': '1.5rem auto' }}>Bạn có chắc xóa người dùng này?</h1>
                            <div className="col-md-6 mx-auto text-center">
                                    ...
                                    <tbody>
                                        <tr className="row">
                                            <td className="col-md-6">
                                                <h5 className=" font-weight-bold">Tên tài khoản</h5>
                                            </td>
                                        ...
                                        <tr className="row">
                                            <td className="col-md-6" >
                                                <h5 className=" font-weight-bold">Họ</h5>
                                            </td>
                                            <td className="col-md-6" >
                                        ...
                                        <tr className="row">
                                            <td className="col-md-6" >
                                                <h5 className=" font-weight-bold">Tên</h5>
                                            </td>
                                            <td className="col-md-6" >
                                        ...
                                        <tr className="row">
                                            <td className="col-md-6" >
                                                <h5 className=" font-weight-bold">Điạ chỉ</h5>
                                            </td>
                                            <td className="col-md-6">
                                        ...
                                        {(isAdmin || isRoot) && <tr className="row">
                                            <td className="col-md-6" >
                                                <h5 className=" font-weight-bold">Quyền</h5>
                                            </td>
                                            <td className="col-md-6" >
                                                <h5>{authority}</h5>
                                            </td>
                                ...
                                <div className="d-flex justify-content-center ">
                                    ...
                                    {(isAdmin || isRoot) && <NavLink className="btn App-button-primary btn-lg m-3" to={`/home/profile/${this.props.id}`} role="button">Hủy</NavLink>}
