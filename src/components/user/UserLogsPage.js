                ...
                <article className="main-article-shared-content">
                    <section className="logs-content-section">
                        <div className="container col-md-11 text-center mx-auto mb-4">
                            <h1 className="text-center font-weight-bold mt-4" style={{ 'margin': '1rem auto' }}>Nhật ký người dùng</h1>
                            <div className="hr-styles"></div>

                            <div className="col-md-4 mx-auto mb-3" >
                                <label className="form-control-label font-weight-bold" htmlFor="search">Nhập tên người dùng:</label>
                                <input
                            ...
                            <div className="col-md-5 d-flex justify-content-center mx-auto mb-5" >
                                <h5>
                                    <button className="btn update-info m-1" onClick={this.searchLogs} >Tìm kiếm</button>
                                </h5>

                                <h5>
                                    <button className="btn update-info m-1" onClick={this.loadAllLogs} >Toàn bộ nhật ký</button>
                                </h5>
                                {userService.isRoot() && this.props.logsArr.length > 0 &&
                                    <h5>
                                        <button className="btn update-info m-1" onClick={this.clearAllLogs} >Xóa toàn bộ</button>
                                    </h5>}

                                {userService.isRoot() && selected &&
                                    <h5>
                                        <button className="btn update-info m-1" onClick={this.clearSelectedLogs} >Xóa</button>
                                    </h5>}
                            </div>
                            ...
                            {this.props.logsArr.length > 0
                                ...
                                <table className="table table-hover mt-3 w-80 mx-auto text-center">
                                    <thead>
                                        <tr className="row " >
                                            ...
                                            <th className="col-md-2" scope="col">Tên người dùng</th>
                                            <th className="col-md-2 " scope="col">Phương thức</th>

                                            <th className="col-md-2 " scope="col">Hành động</th>
                                            <th className="col-md-2" scope="col">Loại</th>

                                            <th className="col-md-3 " scope="col">Thời gian</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        {loading
                                ...
                                loading ?
                                    ...
                                    <Fragment>
                                        <div className="hr-styles"></div>
                                        <h3 className="mt-5 mb-5 mx-auto display-5 text-center App-secondary-color">Nhật ký trống. </h3>
                                        <div className="hr-styles"></div>
                                    </Fragment>
                            }
                        </div>
