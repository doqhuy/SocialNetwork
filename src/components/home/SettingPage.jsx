...
import SettingSideBar from './SettingSidePage';
        ...
        return (
            <Fragment>
                <main className="site-content">
                    <section className="setting-main-section">
                        <Suspense fallback={
                            ...
                            <Fragment>
                                <SettingSideBar/>
                                <div className = "position-static">{loggedIn && <Route exact path="/setting/account/:id" component={SettingMain} />}</div>
                                <div className = "position-static">{loggedIn && <Route exact path="/setting/profile/:id" component={SettingMain} />}</div>
                                <div className = "position-static">{loggedIn && <Route exact path="/setting/pass/:id" component={SettingMain} />}</div>
