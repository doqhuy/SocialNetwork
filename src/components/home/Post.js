...
const Post = (props) => {
    ...
    const month = props.time.month.substring(0, 1) + props.time.month.substring(1, 10).toLowerCase()
            ...
            <div className="post-wrapper" id="container">
                <div className="post-content-article-header ">
                    ...
                    <div className="post-content-article-description">
                        ...
                        <p className="post-description">Lúc {hour}:{minute} {dayTime}, ngày {props.time.dayOfMonth} tháng {month}</p>
                    </div>
                </div>
